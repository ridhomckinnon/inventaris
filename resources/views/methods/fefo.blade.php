...
@section('breadcrumb-title', 'FEFO')
@section('breadcrumb-item', 'FEFO')
...
<div class="col-md-12">
    <div class="d-flex align-items-center justify-content-between">
        <div>
            <h1>Hasil First Expired First Out</h1>
        </div>
        <div>
            <a href="{{ route('fefo.export') }}" target="_blank" class="btn btn-success">Export</a>
        </div>
    </div>
